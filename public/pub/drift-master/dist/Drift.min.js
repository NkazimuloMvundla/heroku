...
!(function(t) {
    ...
    function(t, i, e) {
        function n(t, i) {
            if (((i = void 0 === i ? {} : i), (this.h = t), (this.g = this.g.bind(this)), !a(this.h)))
        ...
        function o(t) {
            ...
            var e = void 0 === i.l ? c() : i.l,
                ...
                l = void 0 === i.f ? c() : i.f;
            (i = void 0 === i.H ? c() : i.H),
                (this.a = { b: t, l: e, R: n, C: s, O: o, N: a, F: r, A: d, D: u, G: f, j: p, f: l, H: i }),
                (this.a.D || this.a.G) && (this.o = new h({ j: this.a.j, f: this.a.f, S: this.a.H })),
                (this.enabled = !0),
                this.M();
        }
        function h(t) {
                ...
                (s = c ? d / 2 : 0),
                    ...
                    this.b.parentElement === this.a.w &&
                        ...
                        this.a.I &&
                            (t < e.left + f
                                ? (t = e.left + f)
                                : t + o > e.left + e.width + f && (t = e.left + e.width - o + f),
                            i < e.top + c
                                ? (i = e.top + c)
                                : i + h > e.top + e.height + c && (i = e.top + e.height - h + c)),
                        (this.b.style.left = t + "px"),
                        (this.b.style.top = i + "px")),
                    this.a.P || (a > s ? (a = s) : a < d && (a = d), r > n ? (r = n) : r < u && (r = u)),
            ...
            (s.prototype.show = function(t, i, e) {
                this.M(),
                    ...
                    this.c.getAttribute("src") != t &&
                        (r(this.b, this.V), this.c.addEventListener("load", this.m, !1), this.X(t)),
                    this.Z(i, e),
