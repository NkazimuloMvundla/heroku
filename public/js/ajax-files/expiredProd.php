...
<div class="dpl-tabs">
        ...
        <span class="next" onclick="javascript:expiredProdTab('<?php echo $nex; ?>')"></span>
        ...
        <?php	}	
			...
			if($previous_btn && $cur_page > 1){
				$pre = $cur_page - 1;
		?>
			<span class="prev" onclick="javascript:expiredProdTab('<?php echo $pre; ?>')"></span>
		...
		<ul class="clearfix" id="productTabs">
			...
			<li id="approvalPendingTab"><a onclick="javascript:pendingApprovalProdTab(1);"><span><?php echo $lang[481]; ?></span> (<span id="approvalPendingCount"><?php echo $count_pendAppr['count']; ?></span>)</a></li>
                   <li class="current" id="expiredTab"><a onclick="javascript:expiredProdTab(1);"><span><?php echo $lang[48]; ?></span> (<span id="expiredCount"><?php echo $count; ?></span>)</a></li>
		</ul>
	</div>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody>
				<tr>
					...
					<th id="dataTableApproved_head_date" class="gmtModified" width="125">
						<div id="dataTableApproved_head_date_sort" class="datatable-head-sort-desc" key="gmtModified" values="desc|asc" default="desc"><?php echo $lang[505]; ?></div>
                    </th>
...
<td id="dataTableApproved_0_3" class="gmtModified AE-datatable-row-0 AE-datatable-col-3" width="125"><?php echo date('d M,Y',strtotime($row->pd_expiry_date)); ?></td>
...
<a href="product-edit.php?pid=<?php echo md5($row->pd_id);?>" class="has-visited" target="_blank">Edit & Re-Post</a>
