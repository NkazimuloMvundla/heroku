...
<form  name="postBuyRequestForm" id="postBuyRequestForm" method="post" action="#" enctype="multipart/form-data">
...
<div id="suggest-wrapper" class="suggest-wrapper"></div>
        ...
        <label class="ui-form-label" for="detailTextarea">
            Product Detailed Specification:     </label>
        <div class="ui-form-control">
            <textarea class="form-control" maxlength="50"  id="br_pd_spec"  name="detailedSpecification" >
              {{ old('detailedSpecification') }}
            </textarea>
