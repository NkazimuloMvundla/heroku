    ...
    <section class="content">
        ...
        <div class="row main-row">
            ...
            <div class="form-group">
                ...
                <input type="text" id="banner_link" name="banner_link" value="{{ old('banner_link') ?? $banner->first()->bn_link }}" class="form-control" >
                @error('banner_link')
            ...
            <div class="form-group">
      <input id="submitFormBtnA" name="submitFormBtnA" value="Update" class="btn btn-success"  type="submit" onclick="return pd_valid();" />
